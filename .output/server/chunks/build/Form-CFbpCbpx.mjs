import { computed, createVNode, ref, shallowRef, watch, createTextVNode, watchEffect, mergeProps, toRef, Fragment, useSSRContext, defineComponent, mergeModels, useModel, unref, withCtx, isRef, toDisplayString, openBlock, createBlock, createCommentVNode, renderList, withModifiers } from 'vue';
import { ssrRenderComponent, ssrRenderList, ssrInterpolate } from 'vue/server-renderer';
import { m as makeFormProps, c as createForm, f as forwardRefs, a as VTextField, b as VMenu, V as VSelect } from './VSelect-B1Jq1ap5.mjs';
import { g as genericComponent, l as propsFactory, ag as useDate, G as useProxiedModel, ai as createRange, m as convertToUnit, V as templateRef, w as makeThemeProps, x as provideTheme, N as omit, R as useLocale, F as wrapInArray, _ as _export_sfc, I as IconValue, K as EventProp, ah as getWeek } from './server.mjs';
import { V as VBtn, m as makeLocationProps, a as makePositionProps, u as useLocation, b as usePosition } from './VBtn-DUYXxIVD.mjs';
import { l as createSimpleFunctional, u as useBackgroundColor, M as MaybeTransition, n as VDefaultsProvider, o as makeBorderProps, e as makeDimensionProps, f as makeElevationProps, p as makeRoundedProps, m as makeTagProps, q as useBorder, g as useDimension, h as useElevation, r as useRounded, d as VFadeTransition, a as VRow, b as VCol } from './index-CFjtekCL.mjs';
import { u as useRender, m as makeComponentProps } from './useRender-DTeZIzyd.mjs';
import { V as VCard, c as VCardTitle } from './VCard-VswUOIBc.mjs';
    ...
    useRender(() => {
      ...
      return createVNode("div", {
        ...
        default: () => {
          ...
          }, [(_a2 = (_a = slots.default) == null ? void 0 : _a.call(slots)) != null ? _a2 : props.header])];
        }
...
function useCalendar(props) {
  ...
  const weekDays = computed(() => {
    var _a;
    const firstDayOfWeek = Number((_a = props.firstDayOfWeek) != null ? _a : 0);
        ...
        return [createVNode("div", {
          ...
          return createVNode("div", {
            ...
            default: () => {
              var _a3;
              var _a2;
              return [(_a3 = (_a2 = slots.day) == null ? void 0 : _a2.call(slots, slotProps)) != null ? _a3 : createVNode(VBtn, slotProps.props, null)];
            }
          })]);
        })])];
      }
...
const VDatePickerMonths = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    watchEffect(() => {
      var _a;
      model.value = (_a = model.value) != null ? _a : adapter.getMonth(adapter.date());
    });
    useRender(() => createVNode("div", {
      ...
      return (_a2 = (_a = slots.month) == null ? void 0 : _a.call(slots, {
        month,
        i,
        props: btnProps
      })) != null ? _a2 : createVNode(VBtn, mergeProps({
        "key": "month"
      }, btnProps), null);
    })])]));
    return {};
...
const VDatePickerYears = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    watchEffect(() => {
      var _a;
      model.value = (_a = model.value) != null ? _a : adapter.getYear(adapter.date());
    });
    ...
    useRender(() => createVNode("div", {
      ...
      return (_a2 = (_a = slots.year) == null ? void 0 : _a.call(slots, {
        year,
        i,
        props: btnProps
      })) != null ? _a2 : createVNode(VBtn, mergeProps({
...
const VDatePicker = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const month = ref(Number((_a = props.month) != null ? _a : adapter.getMonth(adapter.startOfMonth(internal.value))));
    ...
    useRender(() => {
      ...
      return createVNode(VPicker, mergeProps(pickerProps, {
        ...
        title: () => {
          var _a3;
          var _a2;
          return (_a3 = (_a2 = slots.title) == null ? void 0 : _a2.call(slots)) != null ? _a3 : createVNode("div", {
...
//# sourceMappingURL=Form-CFbpCbpx.mjs.map
