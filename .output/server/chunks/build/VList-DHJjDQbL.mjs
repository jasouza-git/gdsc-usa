import { toRef, computed, createVNode, shallowRef, ref, readonly, withDirectives, vShow, watch, Fragment, resolveDirective, mergeProps, inject, provide, toRaw } from 'vue';
import { v as useTextColor, m as makeTagProps, n as VDefaultsProvider, M as MaybeTransition, G as VExpandTransition, l as createSimpleFunctional, o as makeBorderProps, s as makeDensityProps, e as makeDimensionProps, f as makeElevationProps, p as makeRoundedProps, y as makeRouterProps, x as makeVariantProps, R as Ripple, C as useLink, q as useBorder, A as useVariant, w as useDensity, g as useDimension, h as useElevation, r as useRounded, D as genOverlays, i as VAvatar, k as VIcon, u as useBackgroundColor } from './index-CFjtekCL.mjs';
import { m as makeComponentProps, u as useRender } from './useRender-DTeZIzyd.mjs';
import { l as propsFactory, w as makeThemeProps, g as genericComponent, x as provideTheme, m as convertToUnit, J as defineComponent, I as IconValue, K as EventProp, L as deprecate, s as provideDefaults, G as useProxiedModel, A as getCurrentInstance, H as getUid, C as deepEqual, O as focusChild, F as wrapInArray, M as getPropertyFromItem, N as omit } from './server.mjs';
...
export { VList as V, VListItem as a, useSsrBoot as b, VDivider as c, makeItemsProps as m, useItems as u };
//# sourceMappingURL=VList-DHJjDQbL.mjs.map
