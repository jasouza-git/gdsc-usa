...
const _routes = [
  {
    name: "clwang_test-botNav",
    path: "/clwang_test/botNav",
    component: () => import('./botNav-Ux8NdPWC.mjs').then((m) => m.default || m)
  },
  {
    name: "clwang_test-cards",
    path: "/clwang_test/cards",
    component: () => import('./cards-KA385vX2.mjs').then((m) => m.default || m)
  },
  {
    name: "clwang_test-deck",
    path: "/clwang_test/deck",
    component: () => import('./deck-a7xKbqCr.mjs').then((m) => m.default || m)
  },
  {
    name: "clwang_test-form",
    path: "/clwang_test/form",
    component: () => import('./form-BgGGpOhi.mjs').then((m) => m.default || m)
  },
  {
    name: "clwang_test",
    path: "/clwang_test",
    component: () => import('./index-D5kK9BiY.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-Ci7qpc_V.mjs').then((m) => m.default || m)
  },
  {
    name: "test",
    path: "/test",
    component: () => import('./index-xmY1MZ29.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./default-B_ueLJBS.mjs').then((m) => m.default || m),
  error: () => import('./error-44ZikUdP.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-D_kgxird.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-mFwzwAkH.mjs').then((r) => r.default || r));
...
export { filterInputAttrs as $, getCurrentInstance as A, hasEvent as B, deepEqual as C, isObject as D, keyCodes as E, wrapInArray as F, useProxiedModel as G, getUid as H, IconValue as I, defineComponent as J, EventProp as K, deprecate as L, getPropertyFromItem as M, omit as N, focusChild as O, getObjectValueByPath as P, clamp as Q, useLocale as R, isEmpty as S, findChildrenWithProvide as T, consoleWarn as U, templateRef as V, asyncDataDefaults as W, createError as X, isOn as Y, eventName as Z, _export_sfc as _, navigateTo as a, matchesSelector as a0, useToggleScope as a1, only as a2, makeDisplayProps as a3, useGoTo as a4, focusableChildren as a5, consoleError as a6, defer as a7, IN_BROWSER as a8, isClickInsideElement as a9, getNextElement as aa, pick as ab, callEvent as ac, debounce as ad, ensureValidVNode as ae, checkPrintable as af, useDate as ag, getWeek as ah, createRange as ai, __nuxt_component_1 as aj, useNuxtApp as b, useRuntimeConfig as c, resolveUnrefHeadInput as d, entry$1 as default, useDisplay as e, destructComputed as f, genericComponent as g, isCssColor as h, injectHead as i, isParsableColor as j, getForeground as k, propsFactory as l, convertToUnit as m, nuxtLinkDefaults as n, useRtl as o, parseColor as p, breakpoints as q, resolveRouteObject as r, provideDefaults as s, getCurrentInstanceName as t, useRouter as u, includes as v, makeThemeProps as w, provideTheme as x, useIcon as y, flattenFragments as z };
