import { createVNode, Transition, mergeProps, computed, provide, onScopeDispose, toRef, shallowRef, ref, withDirectives, Fragment, resolveDirective, watch, markRaw, vShow, reactive, Teleport, inject, cloneVNode, createTextVNode, nextTick, unref, watchEffect, effectScope, toRaw, readonly, warn } from 'vue';
import { s as makeDensityProps, R as Ripple, k as VIcon, c as makeTransitionProps, t as VSlideYTransition, v as useTextColor, M as MaybeTransition, e as makeDimensionProps, w as useDensity, g as useDimension, m as makeTagProps, d as VFadeTransition, x as makeVariantProps, o as makeBorderProps, f as makeElevationProps, p as makeRoundedProps, y as makeRouterProps, z as makeSizeProps, q as useBorder, A as useVariant, h as useElevation, r as useRounded, B as useSize, C as useLink, D as genOverlays, E as VExpandXTransition, n as VDefaultsProvider, i as VAvatar, u as useBackgroundColor, F as useRouter, I as Intersect } from './index-CFjtekCL.mjs';
import { m as makeComponentProps, u as useRender } from './useRender-DTeZIzyd.mjs';
import { g as genericComponent, l as propsFactory, K as EventProp, w as makeThemeProps, I as IconValue, C as deepEqual, G as useProxiedModel, H as getUid, s as provideDefaults, $ as filterInputAttrs, N as omit, F as wrapInArray, U as consoleWarn, a2 as only, x as provideTheme, o as useRtl, a3 as makeDisplayProps, e as useDisplay, a4 as useGoTo, R as useLocale, A as getCurrentInstance, a1 as useToggleScope, m as convertToUnit, a9 as isClickInsideElement, ae as ensureValidVNode, a0 as matchesSelector, t as getCurrentInstanceName, a5 as focusableChildren, V as templateRef, a8 as IN_BROWSER, aa as getNextElement, O as focusChild, Y as isOn, ab as pick, ac as callEvent, ad as debounce, Q as clamp, af as checkPrintable, Z as eventName, f as destructComputed, a6 as consoleError, a7 as defer } from './server.mjs';
import { c as makeGroupProps, d as useGroup, e as makeGroupItemProps, f as useGroupItem, g as makeLoaderProps, h as useLoader, L as LoaderSlot, p as parseAnchor, i as flipSide, j as flipAlign, k as flipCorner, l as getAxis } from './VBtn-DUYXxIVD.mjs';
import { m as makeItemsProps, u as useItems, V as VList, a as VListItem } from './VList-DHJjDQbL.mjs';
import { u as useResizeObserver } from './resizeObserver-BobTccIq.mjs';
...
export { VSelect as V, VTextField as a, VMenu as b, createForm as c, forwardRefs as f, makeFormProps as m };
//# sourceMappingURL=VSelect-B1Jq1ap5.mjs.map
