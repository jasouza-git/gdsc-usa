...
import { useSSRContext, toRef, computed, createVNode, mergeProps, defineComponent, withCtx, unref, createTextVNode, toDisplayString, openBlock, createBlock, createCommentVNode, provide, ref, watch, watchEffect } from 'vue';
import { ssrRenderComponent, ssrInterpolate } from 'vue/server-renderer';
import { V as VCard, a as VCardText, b as VCardActions } from './VCard-VswUOIBc.mjs';
import { m as makeTagProps, c as makeTransitionProps, d as VFadeTransition, M as MaybeTransition, e as makeDimensionProps, f as makeElevationProps, u as useBackgroundColor, g as useDimension, h as useElevation, a as VRow, b as VCol, i as VAvatar, j as VImg, k as VIcon } from './index-CFjtekCL.mjs';
import { L as LoaderSlot, V as VBtn } from './VBtn-DUYXxIVD.mjs';
import { l as propsFactory, g as genericComponent, G as useProxiedModel, w as makeThemeProps, x as provideTheme, R as useLocale, F as wrapInArray, _ as _export_sfc, A as getCurrentInstance, C as deepEqual, P as getObjectValueByPath, S as isEmpty, M as getPropertyFromItem, Q as clamp } from './server.mjs';
import { m as makeComponentProps, u as useRender } from './useRender-DTeZIzyd.mjs';

const _imports_0 = "" + buildAssetsURL("logo.xct4cwc2.png");
const defaultAvatar = "" + buildAssetsURL("avatar.iufTeu2K.png");
                            ...
                            if (_push5) {
                              _push5(ssrRenderComponent(VCardText, {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  var _a, _b;
                                  if (_push6) {
                                    _push6(`${ssrInterpolate((_a = _ctx.member.summary) != null ? _a : "Biography not found. Maybe they\u2019re a secret agent?")}`);
                                  } else {
                                    return [
                                      createTextVNode(toDisplayString((_b = _ctx.member.summary) != null ? _b : "Biography not found. Maybe they\u2019re a secret agent?"), 1)
                                    ];
                                  }
                                }),
                                _: 1
                              ...
                              return [
                                createVNode(VCardText, {
                                  ...
                                  default: withCtx(() => {
                                    var _a;
                                    return [
                                      createTextVNode(toDisplayString((_a = _ctx.member.summary) != null ? _a : "Biography not found. Maybe they\u2019re a secret agent?"), 1)
                                    ];
                                  }),
                                  _: 1
                                })
                ...
                if (_push3) {
                  if (_ctx.member.fbLink) {
                    _push3(ssrRenderComponent(VBtn, {
                      ...
                      onClick: ($event) => {
                        var _a;
                        return goToLink((_a = _ctx.member.fbLink) != null ? _a : "");
                      }
                    }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                  ...
                  if (_ctx.member.lnLink) {
                    _push3(ssrRenderComponent(VBtn, {
                      ...
                      onClick: ($event) => {
                        var _a;
                        return goToLink((_a = _ctx.member.lnLink) != null ? _a : "");
                      }
                    }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                  ...
                  if (_ctx.member.itLink) {
                    _push3(ssrRenderComponent(VBtn, {
                      ...
                      onClick: ($event) => {
                        var _a;
                        return goToLink((_a = _ctx.member.itLink) != null ? _a : "");
                      }
                    }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
...
function randomColor(colors) {
  if (colors.length === 0)
    return { color: "Not a color!", remainingColors: [] };
...
export { ColorAdjustParas as C, VDataIterator as V, __nuxt_component_1 as _, alterColors as a, VSkeletonLoader as b, randomColor as r };
//# sourceMappingURL=VSkeletonLoader-DHOnnq9S.mjs.map
