import { effectScope, shallowReactive, reactive, getCurrentScope, hasInjectionContext, getCurrentInstance as getCurrentInstance$1, inject as inject$1, toRef, version as version$1, unref, h, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, watch, onScopeDispose, Fragment, computed, watchEffect, toRefs, capitalize, isVNode, Comment, warn, ref, provide, defineComponent as defineComponent$1, createVNode, mergeProps, Suspense, nextTick, Transition, withCtx, useSSRContext, defineAsyncComponent, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/botNav-Ux8NdPWC.js").then((m) => m.default || m)
  },
  {
    name: "clwang_test-cards",
    path: "/clwang_test/cards",
    component: () => import("./_nuxt/cards-KA385vX2.js").then((m) => m.default || m)
  },
  {
    name: "clwang_test-deck",
    path: "/clwang_test/deck",
    component: () => import("./_nuxt/deck-a7xKbqCr.js").then((m) => m.default || m)
  },
  {
    name: "clwang_test-form",
    path: "/clwang_test/form",
    component: () => import("./_nuxt/form-BgGGpOhi.js").then((m) => m.default || m)
  },
  {
    name: "clwang_test",
    path: "/clwang_test",
    component: () => import("./_nuxt/index-D5kK9BiY.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-Ci7qpc_V.js").then((m) => m.default || m)
  },
  {
    name: "test",
    path: "/test",
    component: () => import("./_nuxt/index-xmY1MZ29.js").then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import("./_nuxt/default-B_ueLJBS.js").then((m) => m.default || m),
  error: () => import("./_nuxt/error-44ZikUdP.js").then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-D_kgxird.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-mFwzwAkH.js").then((r) => r.default || r));
...
export {
  ...
  EventProp as K,
  deprecate as L,
  getPropertyFromItem as M,
  omit as N,
  focusChild as O,
  getObjectValueByPath as P,
  clamp as Q,
  useLocale as R,
  isEmpty as S,
  findChildrenWithProvide as T,
  consoleWarn as U,
  templateRef as V,
  asyncDataDefaults as W,
  createError as X,
  isOn as Y,
  eventName as Z,
  _export_sfc as _,
  ...
  useToggleScope as a1,
  only as a2,
  makeDisplayProps as a3,
  useGoTo as a4,
  focusableChildren as a5,
  consoleError as a6,
  defer as a7,
  IN_BROWSER as a8,
  isClickInsideElement as a9,
  getNextElement as aa,
  pick as ab,
  callEvent as ac,
  debounce as ad,
  ensureValidVNode as ae,
  checkPrintable as af,
  useDate as ag,
  getWeek as ah,
  createRange as ai,
  __nuxt_component_1 as aj,
  useNuxtApp as b,
